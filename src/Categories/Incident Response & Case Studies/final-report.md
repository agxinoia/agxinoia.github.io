...
<svg viewBox="0 0 520 240" width="100%" role="img" aria-label="Exploit escalation timeline">
  <style>
    .node-text { fill: #ededed; font: 12px Inter, sans-serif; font-weight: 500; }
    .sub-text { fill: #737373; font: 10px Inter, sans-serif; }
    .line { stroke: rgba(255,255,255,0.1); stroke-width: 2; }
    .point { fill: #ffffff; }
    .danger { fill: #ef4444; }
  </style>
  <rect x="0" y="0" width="520" height="240" fill="#0a0a0a" rx="12"></rect>
  
  <!-- Timeline Line -->
  <line x1="60" y1="180" x2="460" y2="180" class="line"></line>
  
  <!-- Step 1 -->
  <circle cx="80" y="180" r="4" class="point"></circle>
  <text x="80" y="160" text-anchor="middle" class="node-text">Recon</text>
  <text x="80" y="200" text-anchor="middle" class="sub-text">Traffic Proxying</text>
  
  <!-- Step 2 -->
  <circle cx="180" y="180" r="4" class="point"></circle>
  <text x="180" y="160" text-anchor="middle" class="node-text">Discovery</text>
  <text x="180" y="200" text-anchor="middle" class="sub-text">Serialized Cookie</text>
  
  <!-- Step 3 -->
  <circle cx="280" y="180" r="4" class="point"></circle>
  <text x="280" y="160" text-anchor="middle" class="node-text">IDOR</text>
  <text x="280" y="200" text-anchor="middle" class="sub-text">Account Takeover</text>
  
  <!-- Step 4 -->
  <circle cx="380" y="180" r="6" class="danger"></circle>
  <text x="380" y="160" text-anchor="middle" class="node-text" style="fill:#ef4444">SQLi</text>
  <text x="380" y="200" text-anchor="middle" class="sub-text">Database Access</text>
  
  <!-- Step 5 -->
  <circle cx="440" y="180" r="4" class="point"></circle>
  <text x="440" y="160" text-anchor="middle" class="node-text">Disclosure</text>
  <text x="440" y="200" text-anchor="middle" class="sub-text">Source Exposed</text>
</svg>
